...
plt.savefig("Task2/images/wine_adaline_loss.png")
plt.close()
...
plt.savefig("Task2/images/wine_logistic_loss.png")
plt.close()
...
plt.savefig("Task2/images/iris_adaline_loss.png")
plt.close()
...
plt.savefig("Task2/images/iris_logistic_loss.png")
plt.close()
